        ...
        <div className={`animate-fade-in pb-24 text-slate-100 ${isRtl ? 'font-reishi-body' : ''}`}>
            ...
            <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center text-center overflow-hidden bg-stone-950">
                ...
                <div className="absolute inset-0 w-full h-full">
                    <video 
                        src="https://qsikfiqqjxgichvjkvbz.supabase.co/storage/v1/object/public/media/Identification.mp4" 
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6">
                    ...
                    <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold tracking-tight chrome-gold-text drop-shadow-[0_4px_10px_rgba(0,0,0,0.9)] mb-6">
                        {t.im_hero_title}
                    </h1>
